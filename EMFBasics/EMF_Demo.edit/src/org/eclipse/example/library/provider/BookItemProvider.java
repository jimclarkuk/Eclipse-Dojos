...
public class BookItemProvider
	...
	protected void addBorrowedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Book_borrowed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Book_borrowed_feature", "_UI_Book_type"),
				 LibraryPackage.Literals.BOOK__BORROWED,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Book2"));
	}
