...
import org.eclipse.example.library.action.DeleteBorrowedBooksAction;
...
public class LibraryActionBarContributor
	...
	DeleteBorrowedBooksAction deleteBorrowedBooksAction = new DeleteBorrowedBooksAction(null);
	...
	public void init(IActionBars bars) {
		...
		if (editorPart instanceof IEditingDomainProvider)	{
			IEditingDomainProvider activeEditor = (IEditingDomainProvider)getActiveEditor();
			deleteBorrowedBooksAction = new DeleteBorrowedBooksAction(activeEditor.getEditingDomain());	
		}
	}
	...
	public void setActiveEditor(IEditorPart part) {
		...
		if (part instanceof IEditingDomainProvider){
			deleteBorrowedBooksAction.setEditingDomain(((IEditingDomainProvider) part).getEditingDomain());
        }
	}
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		this.deleteBorrowedBooksAction.selectionChanged(event);
	}
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		menuManager.add(deleteBorrowedBooksAction);
